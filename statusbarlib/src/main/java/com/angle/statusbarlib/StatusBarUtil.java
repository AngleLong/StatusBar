package com.angle.statusbarlib;
...
/**
 * 状态栏工具类
 * https://www.jianshu.com/p/3042bf7d72e3
        ...
        if (!isTextDark) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
                if (OSUtil.isMIUI()) {
                    ...
                    //4.4以上6.0以下的其他系统，暂时没有修改状态栏的文字图标颜色的方法，
                    //这里虽然没有，我把状态栏设置成了相应的半透明，其实这里最好还是设置一下相应的透明度才好
                    setDefault(activity, isTextDark, colorId);
                }
            }
        }
    }
    ...
    public static boolean setFlymeStatusBarTextMode(Activity activity, boolean isDark) {
        ...
        if (window != null) {
            try {
                ...
                Log.e(TAG, "StatusBarUtil中捕获了一个异常");
            }
        }
        return result;
    }
